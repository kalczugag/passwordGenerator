...
const passwordSettings = () => {
  ...
  } else if ((document.getElementById("numbers") as HTMLInputElement).checked) {
    passwordSignsArray.concat(NUMBERS);
  } else if ((document.getElementById("symbols") as HTMLInputElement).checked) {
    passwordSignsArray.concat(SYMBOLS);
  } else if (
    (document.getElementById("duplicate") as HTMLInputElement).checked
  ) {
    console.log("xd");
  } else if ((document.getElementById("spaces") as HTMLInputElement).checked) {
    console.log("xd");
  }
};
